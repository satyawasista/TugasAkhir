...
@section('breadcrumc')
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Laporan Kunjungan Pasien Umum</li>
      </ol>
    </nav>
@endsection
      ...
      <div class="col-xs-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="col-auto">
              <a onclick="this.href='/cetakLaporan/'+ document.getElementById('tglawal').value +
